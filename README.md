...
|---|---|---|---|
| 1 |Вебсторінка |HTML-код сторінок. <html>        <head>                <title>               <style>                 <body>        <noscript> | Це вміст (HTML/CSS/JS) HTTP-відповіді, який передається мережею для інтерпретації та відображення у браузері користувача. |
