...
> Значення 443 з'явилося тому, що порт 443 є стандартним портом за замовчуванням для протоколу HTTPS. Коли в адресі порт не вказується явно, curl автоматично підставляє стандартний порт 443 для встановлення захищеного з'єднання.
