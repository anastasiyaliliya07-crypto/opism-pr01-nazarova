...
|---|---|
|`* Request completely sent off` |Програма curl каже нам, що вона закінчила вивантажувати дані зі свого буфера в мережу. Це просто повідомлення про внутрішній стан програми, а не про надісланий мережевий пакет чи HTTP-заголовок. |
